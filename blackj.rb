...
standard black jack where dealer cannot have less than 17.
player can see two initial cards and only one of dealer's cards.
...
player should hit once as they cannot bust with any card (ace would win)

dealer has: 7 && ??
player has: 10 && 7

player stays as 17 is either tie or dealer bust.
...
step 2 - deal cards to player and dealer
step 3 - player turn: hit or stay
  step 3.a - repeat until bust? or stay.
  step 3.b - if player bust, dealer wins.
step 4- dealer turn: hit or stay.
    step 4.a - repeat until total is >= 17.
step 5 - if dealer busts, player wins.
step 6 - compare cards and declare winner.
